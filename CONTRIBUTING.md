...
`cloud-itonami-4220` accepts contributions to the OSS blueprint,
...
the business blueprint, the Utility-Construction Advisor/Governor actor
...
- Keep every proposal behind the Utility-Construction Governor, and keep
...
- Never extend this actor's op-allowlist, advisor or governor to permit
  heavy-equipment control or a utility-tie-in/energization-authorization
  decision. That is a hard scope boundary, not a rollout milestone --
...
- Extending `utilconstr.facts` coverage to a new jurisdiction requires a
