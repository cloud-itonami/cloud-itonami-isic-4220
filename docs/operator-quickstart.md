# Operator Quickstart — Construction of Utility Projects

Shortest path from clone to a verified local dry-run for **ISIC 4220** (`cloud-itonami-isic-4220`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4220.git
cd cloud-itonami-isic-4220
```
...
- Blueprint governor key: `utility-construction-governor`
- Likely source path: `utilconstr.governor.cljc`
