# Business Model: Construction of Utility Projects
...
## Classification
- Repository: `cloud-itonami-isic-4220` ([github.com/cloud-itonami/cloud-itonami-isic-4220](https://github.com/cloud-itonami/cloud-itonami-isic-4220))
- ISIC Rev.5: `4220` — Construction of Utility Projects
- Domain: `:construction/utility-projects`
- Social impact: :worker-safety :public-utility-reliability :buried-infrastructure-protection
- Actor: `:utility-construction-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :construction/utility-projects — who wants
...
One managed tenant (:construction/utility-projects):
...
- Do not bypass the `:utility-construction-governor` for production decisions.
